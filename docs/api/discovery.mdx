...
// antigravity: /Users/example/.local/bin/agy
```
...
Discover the first available CLI binary. Priority order: Claude → Codex → Antigravity. All lookups run concurrently and the highest-priority match is returned.
